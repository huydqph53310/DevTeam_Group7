...
<head>
  ...
  <title>Thêm tài khoản- Quản trị F-Mchine</title>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tạo tài khoản và phân quyền</h5>

              <!-- Multi Columns Form -->
              <form class="row g-3">
                <div class="col-md-12">
                  <label for="inputName5" class="form-label">Tên của bạn</label>
                ...
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Địa chỉ nhận hàng</label>
