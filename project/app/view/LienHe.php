...
<html lang="vi">
	<head>
		...
		<link rel="canonical" href="https://ego-mobile.mysapo.net/lien-he"/>
...
<meta name="description" content="">
		<title>Liên hệ		</title>
		<meta name="keywords" content="Liên hệ, Ego Mobile, ego-mobile.mysapo.net"/>		
...
<meta property="og:url" content="https://ego-mobile.mysapo.net/lien-he">
...
<link rel="preload" as='style' type="text/css" href="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/contact_style.scss.css?1731407153286">
<link href="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/contact_style.scss.css?1731407153286" rel="stylesheet" type="text/css" media="all" />
...
<script type="application/ld+json">
      ...
      
      {
                ...
                "item": 
                {
                  "@id": "https://ego-mobile.mysapo.net/lien-he",
                  "name": "Liên hệ"
                }
            }
...
<div class="page_contact ">
	<div class="container">
		<div class="white">
			<h1 class="title-module">Liên hệ</h1>
		<div class="row">
			<div class="col-12 order-lg-2 order-2">
				<div class="row">
					...
					<div class="col-md-6 col-12">
						<div id="pagelogin" class="white">
							<form method="post" action="/postcontact" id="contact" accept-charset="UTF-8"><input name="FormType" type="hidden" value="contact"/><input name="utf8" type="hidden" value="true"/><input type="hidden" id="Token-7f94abcdb4d049da87f8b9c898e531f8" name="Token" /><script src="https://www.google.com/recaptcha/api.js?render=6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK"></script><script>grecaptcha.ready(function() {grecaptcha.execute("6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK", {action: "contact"}).then(function(token) {document.getElementById("Token-7f94abcdb4d049da87f8b9c898e531f8").value = token});});</script>
									...
									<div class="col-lg-12 col-12">
										<div class="row">
											<fieldset class="form-group col-12">
												...
												<input placeholder="" type="text" class="form-control  form-control-lg" required value="huy do" name="contact[Name]">
											</fieldset>

											<fieldset class="form-group col-12">
												<label>Email <em>*</em></label>
												<input placeholder="" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required id="email1" class="form-control form-control-lg" value="Admin.runsytem.mod@huydev.id.vn" name="contact[email]">
											</fieldset>
										</div>
									</div>
									<div class="col-lg-12 col-12">
