...
<head>
    ...
    <link rel="canonical" href="https://ego-mobile.mysapo.net/account/login" />
    ...
    <meta name="keywords" content="Đăng nhập tài khoản, Ego Mobile, ego-mobile.mysapo.net" />
    ...
    <meta property="og:url" content="https://ego-mobile.mysapo.net/account/login">
    ...
    <main>
                    ...
                    <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                        <div class="d-group">
                            ...
                            <div class="right-col">
                                ...
                                <a href="?wh=reg" class="btn-register-default">Đăng ký</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            function showRecoverPasswordForm() {
                const groupLog = document.querySelector('.group-log');
                const groupRecover = document.querySelector('.group-recover');

                groupLog.classList.add('d-none');
                groupRecover.classList.remove('d-none');
            }
            ...
            function hideRecoverPasswordForm() {
                ...
                groupRecover.classList.add('d-none');
                groupLog.classList.remove('d-none');
            }
