...
<head>
    ...
    <link rel="canonical" href="https://ego-mobile.mysapo.net/account/orders" />
    ...
    <meta name="keywords" content="Trang đơn hàng, Ego Mobile, ego-mobile.mysapo.net" />


    <meta property="og:type" content="website">
    <meta property="og:title" content="Trang đơn hàng">
    <meta property="og:image"
        content="https://bizweb.dktcdn.net/100/507/051/themes/936909/assets/share_fb_home.jpg?1731407153286">
    <meta property="og:image:secure_url"
        content="https://bizweb.dktcdn.net/100/507/051/themes/936909/assets/share_fb_home.jpg?1731407153286">

    <meta property="og:description" content="">
    <meta property="og:url" content="https://ego-mobile.mysapo.net/account/orders">
    ...
    <link rel="preload" as='style' type="text/css"
        href="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/account_oder_style.scss.css?1731407153286">
    <link href="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/account_oder_style.scss.css?1731407153286"
        rel="stylesheet" type="text/css" media="all" />
    ...
    <script>
        ...
        theme.settings = {
            productSize: 32,
            storage: false,
            templateCurrent: 'customers/orders',
    ...
    <script>
        ...
        Bizweb.template = 'customers/orders';
    ...
    <script>
        ...
        meta.customer = {
            ...
            "last_name": "do",
            "phone": "84977675028",
            "email": "admin.runsytem.mod@huydev.id.vn"
        };
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-9 col-xl-9 group-header-action">
                        ...
                        <div class="item-header block-store">
                            <svg class="icon">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shopicon"></use>
                            </svg>
                            <div class="right-item">
                                Hệ thống
                    ...
                    <div class="col-12 col-lg-12 col-mobile">
                        <div class="navigation-header header_nav_main">
                            <div class="navigation-head">
                                ...
                                <div class="first-nav d-xl-none d-flex">
                                    ...
                                    <div class="block-img-acc lazyload"
                                        data-src="https://www.gravatar.com/avatar/8b9fa0764e23df55c8de92347e7045fb?d=mp">
                                    </div>
                                    <div class="text-left">
                                        <a class="btnx" href="/account" title="Tài khoản">Xin chào: <span>do
                                                huy</span></a>
                                        <a href="/account/logout" title="Đăng xuất">Đăng xuất</a>
                                    </div>
					   ...
					   is-icon lazyload" data-src="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/tag_image_menu_5.png?1731407153286">
                                            ...
                                            <div class="mega-content">
                                                <ul class="level0">
                                                    ...
                                                    <li class="level1 parent item">
                                                        <h4>
                                                            <a href="/gia-dung-smart-home"
                                                                title="Gia dụng, Smart home">Gia dụng, Smart home</a>
                                                            <svg class="icon">
                                                                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                    xlink:href="#icondown"></use>
                                                            </svg>
                                                    ...
                                                    <li class="level1 parent item">
                                                        ...
                                                        <ul class="level1">
                                                            ...
                                                            <li class="level2"><a href="/pad-chuot"
                                                                    title="Pad chuột">Pad chuột</a> </li>
					   ...
					   ">
                                ...
                                <div class="last-nav d-xl-none d-flex">
                                    <div class="item-header block-phone">
                                        <svg class="icon">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#phoneicon">
                                            </use>
                                        </svg>
                                        <div class="right-item ">
                                            Gọi đặt hàng
                                ...
                                <div class="my-account">
                                    <div class="dashboard">
                                        ...
                                        <div class="recent-orders">
                                            ...
                                            <div
                                                class="paginate-pages pull-right page-account pagenav text-right col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <ul class="list-menu">
                            ...
                            <li class="li_menu"><a href="/he-thong-cua-hang" title="Cơ sở chính thức">Cơ sở chính
                                    thức</a></li>

                            <li class="li_menu"><a href="/he-thong-cua-hang" title="Địa điểm bán hàng">Địa điểm bán
                                    hàng</a></li>

                            <li class="li_menu"><a href="/gioi-thieu" title="Tuyển cộng tác viên">Tuyển cộng tác
                                    viên</a></li>

                            <li class="li_menu"><a href="/gioi-thieu" title="Tuyển dụng">Tuyển dụng</a></li>

                            <li class="li_menu"><a href="/gioi-thieu" title="Fanpage trực tuyến">Fanpage trực tuyến</a>
                            </li>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <ul class="list-menu">
                            ...
                            <li class="li_menu"><a href="/gioi-thieu" title="Đôi nét về công ty">Đôi nét về công ty</a>
                            </li>

                            <li class="li_menu"><a href="/gioi-thieu" title="Lịch sử hình thành">Lịch sử hình thành</a>
                            </li>

                            <li class="li_menu"><a href="/gioi-thieu" title="Giải thưởng cao quý">Giải thưởng cao
                                    quý</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <ul class="list-menu">
                            ...
                            <li class="li_menu"><a href="/chinh-sach-chung" title="Chính sách chung">Chính sách
                                    chung</a></li>

                            <li class="li_menu"><a href="/chinh-sach-chung" title="Chính sách đổi trả">Chính sách đổi
                                    trả</a></li>

                            <li class="li_menu"><a href="/chinh-sach-chung" title="Chính sách bảo hành">Chính sách bảo
                                    hành</a></li>

                            <li class="li_menu"><a href="/chinh-sach-chung" title="Chính sách thành viên">Chính sách
                                    thành viên</a></li>

                            <li class="li_menu"><a href="/chinh-sach-chung" title="Chính sách điểm thưởng">Chính sách
                                    điểm thưởng</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <ul class="list-menu">
                            ...
                            <li class="li_menu"><a href="https://www.facebook.com/" title="Theo dõi trên Fanpage">Theo
                                    dõi trên Fanpage</a></li>

                            <li class="li_menu"><a href="https://www.instagram.com/"
                                    title="Theo dõi trên Instagram">Theo dõi trên Instagram</a></li>

                            <li class="li_menu"><a href="https://twitter.com/home?lang=vi" title="Theo dõi trên X">Theo
                                    dõi trên X</a></li>

                            <li class="li_menu"><a href="/" title="Theo dõi trên Tiktok">Theo dõi trên Tiktok</a></li>

                            <li class="li_menu"><a href="https://www.youtube.com/" title="Theo dõi trên Youtube">Theo
                                    dõi trên Youtube</a></li>
    ...
    <script src="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/quickview-func.js?1731407153286"
        type="text/javascript"></script>
    <link rel="preload"
        href="//bizweb.dktcdn.net/100/507/051/themes/936909/assets/js-customer-validate.js?1731407153286" as="script">
