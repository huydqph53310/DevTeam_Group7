            ...
            <div class="container">
                <div class="row">
                    ...
                    <style>
                        ...
                        .status-paid {
                            color: #4caf50;
                            /* Màu xanh lá cho trạng thái "paid" */
                        }

                        .status-Cancelled {
                            color: #F44336;
                            /* Màu xanh dương cho trạng thái "shipped" */
                        }

                        .status-completed {
                            color: #9e9e9e;
                            /* Màu xám cho trạng thái "completed" */
                        }

                        .status-default {
                            color: #e0e0e0;
                            /* Màu xám nhạt cho trạng thái mặc định */
                        }
                                                        ...
                                                        <?php if ($orders  !== null) { ?>
                                                            <?php foreach ($orders as $order) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= number_format($order["total_amount"] * 24000, 0, ',', '.') ?> VNĐ</td>
                                                                    <?php
                                                                    ...
                                                                    <td>
                                                                        <?php 
                                                                        if (strtolower($order["status"]) != 'paid' && strtolower($order["payment_status"]) != 'paid' && strtolower($order["status"]) !== 'cancelled' && strtolower($order["payment_method"]) !== 'cash')  { ?>
