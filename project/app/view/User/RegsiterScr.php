...
<head>
    ...
    <link rel="canonical" href="https://ego-mobile.mysapo.net/account/register" />
    ...
    <meta name="keywords" content="Đăng ký tài khoản, Ego Mobile, ego-mobile.mysapo.net" />
    ...
    <meta property="og:url" content="https://ego-mobile.mysapo.net/account/register">
    ...
    <script>
        ...
        theme.settings = {
            productSize: 32,
            storage: false,
            templateCurrent: 'customers/register',
...
<body>
                    ...
                    <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                        <div class="d-group">
                                    ...
                                    <form method="post" action="" id="customer_register" accept-charset="UTF-8">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="name"
                                                id="name" placeholder="Họ" placeholder="Họ Và Tên">
                                        </fieldset>
                                        <fieldset class="form-group">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input placeholder="Số điện thoại" type="text" pattern="\d+"
                                                id="PhoneNumber"
                                                class="form-control form-control-comment form-control-lg" name="phone"
                                                Required>
                                        </fieldset>
                                        <fieldset class="form-group">
                                            <label>Username<span class="required">*</span></label>
                                            <input type="text" class="form-control form-control-lg" name="username"
                                                id="username" placeholder="Username" placeholder="username">
                                        </fieldset>
                                        <fieldset class="form-group">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <select id="tinh" class="form-control" onchange="loadHuyen()" name="tinh">
                                                <option value="">--Chọn Tỉnh/Thành phố--</option>
                                            </select>
                                        </fieldset>

                                        <!-- Dropdown chọn Huyện/Quận (ẩn đi ban đầu) -->
                                        <fieldset class="form-group" id="huyen-group" style="display: none;">
                                            <label for="huyen">Huyện/Quận:</label>
                                            <select id="huyen" class="form-control" onchange="loadXa()" name="huyen">
                                                <option value="">--Chọn Huyện/Quận--</option>
                                            </select>
                                        </fieldset>

                                        <!-- Dropdown chọn Xã/Phường (ẩn đi ban đầu) -->
                                        <fieldset class="form-group" id="xa-group" style="display: none;">
                                        ...
                                        <?php if (!empty($tbsus)): ?>
                                            <p style="color: green;"><?php echo htmlspecialchars($tbsus); ?></p>
                                        <?php endif; ?>
                                        <?php if (!empty($tberr)): ?>
                                            <div style="color: red;"><?php echo htmlspecialchars($tberr); ?></div>
                                        <?php endif; ?>
                                        <button class="btn-login" type="submit" name="regsiter">Đăng ký</button>
                                    </form>
                                        ...
                                        <script>
                                            function loginFacebook() {
                                                var a = {
                                                    ...
                                                    b = "https://www.facebook.com/v3.2/dialog/oauth" + encodeURIParams(a, !
                                                        0);
                                            ...
                                            function loginGoogle() {
                                                var a = {
                                                    ...
                                                    b = "https://accounts.google.com/o/oauth2/v2/auth" + encodeURIParams(a,
                                                        !0);
                                                window.location.href = b
                                            }
                            ...
                            <div class="right-col">
                                ...
                                <a href="?wh=login" class="btn-register-default">Đăng nhập</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="app/view/asset/js/HanhChinhVn.js"></script>
